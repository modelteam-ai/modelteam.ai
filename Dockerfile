...
RUN echo "0 0 * * 0 su - modelteam -c 'cd /home/modelteam/app/ && python3 setup.py && python3 process_teams.py -r /home/modelteam/repos -c api_config.ini' >> /home/modelteam/app/cron.log 2>&1" > /etc/cron.d/weeklyjob

# Correct permissions and apply cron job for modelteam
RUN chmod 0644 /etc/cron.d/weeklyjob && \
    crontab /etc/cron.d/weeklyjob

RUN touch /home/modelteam/app/cron.log && chown modelteam:modelteam /home/modelteam/app/cron.log
RUN git config --global safe.directory '*'

VOLUME ["/home/modelteam/repos"]

CMD ["sh", "-c", "cron && tail -f /home/modelteam/app/cron.log"]
