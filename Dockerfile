...
RUN echo "0 0 * * 0 su - modelteam -c 'python3 /home/modelteam/app/setup.py && python3 /home/modelteam/app/gen_team_git_stats.py -r /home/modelteam/repos -t modelteam' >> /var/log/cron.log 2>&1" > /etc/cron.d/weeklyjob
