...
RUN echo "0 0 * * 0 su - modelteam -c 'cd /home/modelteam/app/ && python3 setup.py && source mdltm/bin/activate && python3 process_teams.py -r /home/modelteam/repos -c api_config.ini' >> /var/log/cron.log 2>&1" > /etc/cron.d/weeklyjob
